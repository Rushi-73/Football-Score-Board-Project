...
public class UserDisp {
	...
	private void initialize() {
		...
		String data=UserSearch.srch.getText();
		int flag=0;
		try {
			...
			while(rs.next())
			{
				...
				{
				    String team_A = rs.getString("Team_name");
				    teamA.setText(team_A);
				    String goal_A = rs.getString("goal");
				    ...
				    String team_B = rs.getString("Team_name");
				    teamB.setText(team_B);
				    String goal_B = rs.getString("goal");
